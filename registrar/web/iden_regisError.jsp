...
<html>
    ...
    <body>
        <br><br><br>
        <p align="center" class="error">Los datos introducidos son incorrectos. Introduzcalos de nuevo</p>
        <table align="center" >
        ...
        <td  class="datos" align="center" >
            <form name="entrada" id="entrada" action="comprobarUsuario" method="post"> 
            <br>
            ...
            Contraseña:
            <br>
            <input type="text" size="50px" name="passw" id="passw" />
            <br><br>
       ...
       <td align="center">
            <form name="regis" id="regis" action= method="post">
